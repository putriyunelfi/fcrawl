...
#error
    link = 'http://6nhmgdpnyoljh5uzr5kwlatx2u3diou4ldeommfxjz3wkhalzgjqxzqd.onion/'
    res = requests.get(link, params={'q': query}, proxies=proxies) #memasukkan url yang akan di crawl # akses links.txt dari hasil github agus
